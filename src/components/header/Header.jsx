...
import logo from "../../assets/logo_color_text.png"
    ...
    <div className='header section__padding'>
      <div className={"header-content-content"}>
        ...
        <div className="header-content">
          ...
          <h1>Si je meurs...</h1>
          <p>
            Qui aura la garde de mes enfants ? De mes chats ? Est-ce que je veux donner mes organes ? Offrir mon corps à la Science ? Qu’est-ce qu’on fait de mes réseaux sociaux ?
            <br/> Et si je meurs demain, qu’est-ce que je n’aurai pas eu le temps de dire ? A quels moments je ne serai pas </p>
          </div>
        </div>
      </div>
